...
emailjs.init("YMay5SDAdYqvOjIjm");
...
document.getElementById("access-form").addEventListener("submit", async function (e) {
    ...
    const sendEmail = async () => {
        ...
        try {
            const response = await emailjs.send("service_rxwn6ig", "template_aoqa2dj", templateParams);
    ...
    const customMessages = {
        ...
        sharingthenighttogether: 'Con aprecio quería compartirte la canción, espero que te haya gustado. Además, me gustaria que leyeras algo más en un apartado especial (clave: nadine).',
        hojasfinas: 'ʕ•́ᴥ•̀ʔっ.........♥',
        cejasfinas: 'ʕ♥ᴥ♥ʔっ......🥥',
